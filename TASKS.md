# mini-httpd · 任务分解（路线图「探针 A」）

> 对应路线图 [`/roadmap/00-direction/`](https://onedasein.github.io/roadmap/00-direction/) 的探针 A
> 与 [`/roadmap/05-plan/`](https://onedasein.github.io/roadmap/05-plan/) 里大二上的「周 3–4」。
> **交付物（路线图原文）**：GitHub repo + README（含压测数据与优化前后对比）+ 200 字「哪里最爽 / 最烦」。
...
| **M3** | 健壮性与对抗测试 | 9h | 周 4 末（路线图说的「真实折磨」） |
| **M4** | 压测与第一轮优化 | 10h | 周 5–6 |
| **M5** | 交付 | 4h | 周 5–6 |

> 探针 A 本体（M1–M4）≈ 43h，与路线图给的「30–50 小时」吻合；M0 是额外热身。
...
> 时间不够就按「3 小时能做完的最小步」推进：**每次只取一个 T 编号**，不要同时开两个。
